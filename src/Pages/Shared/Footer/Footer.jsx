...
const Footer = () => {
  ...
  return (
    <footer className="footer footer-horizontal footer-center bg-[#0b0b0b] text-primary-content p-10 rounded-t-2xl">
      <aside>
        <Logo></Logo>
      ...
      <div className="border border-b-1 w-[1100px] border-secondary border-dotted "></div>
